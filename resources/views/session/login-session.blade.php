            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Hệ thống quản lý phòng GYM</h3>
                </div>
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" name="phone" id="phone" placeholder="Số điện thoại" aria-label="Phone" aria-describedby="phone-addon">
                      @error('phone')
