            ...
            <div class="row">
              <div class="col-4 py-3 ps-0">
                <div class="d-flex mb-2">
                  ...
                  <p class="text-xs mt-1 mb-0 font-weight-bold">Khách hàng</p>
                </div>
              ...
              <div class="col-4 py-3 ps-0">
                <div class="d-flex mb-2">
                  ...
                  <p class="text-xs mt-1 mb-0 font-weight-bold">Dịch vụ</p>
                </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-7">
              ...
              <p class="text-sm mb-0">
                ...
                <span class="font-weight-bold ms-1">Tổng: </span>
              </p>
            </div>
            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Người hướng dẫn</th>
