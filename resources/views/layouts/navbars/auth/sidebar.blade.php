<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="https://media.istockphoto.com/id/1331186720/vector/dumbbell.jpg?s=612x612&w=0&k=20&c=ztAKf6ZaSrWTBQVW7Nj2yrEbGM0FxitFrze39W-HdMs="
                 class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 fz-30 font-weight-bold">GYM</span>
        </a>
    </div>
    ...
    <div style="height: 100%" class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">KHÁCH HÀNG</h6>
            </li>
            @if(auth()->user()->role != 3)
                <li class="nav-item">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('customer-services*') ? 'active' : '') }}"
                   href="{{ route('customer_services.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>customer-support</title>
                    ...
                    <span class="nav-link-text ms-1">Dịch vụ khách hàng</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('customer-schedules*') ? 'active' : '') }}"
                   href="{{ route('customer_schedules.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>customer-support</title>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ (Request::is('agencies*') ? 'active' : '') }}"
                       href="{{ route('agencies.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Quản lý chi nhánh</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ (Request::is('services*') ? 'active' : '') }}"
                       href="{{ route('services.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Quản lý dịch vụ</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            @if(auth()->user()->role === 1)
                ...
                <li class="nav-item">
                    <a class="nav-link {{ (Request::is('pages*') ? 'active' : '') }}" href="{{route('pages.index')}}">
                        ...
                        <span class="nav-link-text ms-1">Quản lý trang</span>
                    </a>
                </li>
            @endif
        </ul>
